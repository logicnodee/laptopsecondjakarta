      ...
      <div className="bg-slate-900 text-slate-300 text-[10px] py-1 hidden md:block">
        <div className="container mx-auto px-4 lg:px-8 flex justify-between items-center">
          <div className="flex gap-4">
            <a href="https://maps.app.goo.gl/h7K6hrkVmc72TiXG7?g_st=ic" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Lokasi Toko di Jakarta</a>
          </div>
